...
node[:deploy].each do |application, deploy|
  ...
  default[:deploy][application][:symlinks] = {"system" => "public/system", "pids" => "tmp/pids", "log" => "log", "config/credentials/#{deploy[:rails_env]}.key" => "config/credentials/#{deploy[:rails_env]}.key"}
